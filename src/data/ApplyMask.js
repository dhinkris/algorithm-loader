const ApplyMask = {
    "inputs": [
        ...
        },
        {
            ...
            "type": "File",
            "id": "input_mask_file",
            "description": "An existing file name. Binary image defining mask space."
        },
        {
    ...
    "name": "ApplyMask",
    "command-line": "nipype_cmd nipype.interfaces.fsl ApplyMask [ARGS] [ENVIRON] [IGNORE_EXCEPTION] [IN_FILE] [INTERNAL_DATATYPE] [MASK_FILE] [NAN2ZEROS] [OUT_FILE] [OUTPUT_DATATYPE] [OUTPUT_TYPE] [TERMINAL_OUTPUT] ",
    "tool-version": "5.0.6",
